...
class TestMinimumSpanningTree(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.df = pd.DataFrame({
            ...
            'marker_symbol': np.random.choice(['circle', 'square', 'diamond', 'triangle-up'], self.sample_size),
    ...
    def test_create_node_trace(self):
        ...
        node_trace = self.mst_plotter.create_node_trace(node_x, node_y, node_adjacencies)
