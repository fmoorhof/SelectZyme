...
class TestUniProtFetcher(unittest.TestCase):
    ...
    @patch('src.fetch_data_uniprot.Session')
    def setUp(self, MockSession):
        self.df_coi = ['accession', 'id', 'reviewed', 'protein_name', 'gene_names', 'organism_name']
    ...
    @patch('src.fetch_data_uniprot.UniProtFetcher._get_next_link')
